...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16 text-white">
        <div className="font-[family-name:var(--font-display)] text-6xl md:text-7xl tracking-tight text-[#0f766e]">MarketBiqs</div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/register">
            <Button className="!bg-[#f3f0e8] !text-[#14231f]">Start free onboarding</Button>
          </Link>
          <Link href="/login">
